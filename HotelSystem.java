...
public class HotelSystem extends JFrame {
    ...
    private JTextArea displayArea; // This is the "System Log" where search results appear

    // Tab 2 Components
    private JTextField bookGuestIdField, bookRoomField, bookNightsField;
    private JRadioButton rCash, rCard; // Payment options
    ...
    public HotelSystem() {
        // 1. Main Window Setup
        setTitle("Yakyakyay Hotel");
        setSize(750, 550); // Made slightly bigger
    ...
    private JPanel createGuestPanel() {
        ...
        JButton btnSearch = new JButton("Search ID (View History)");
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Search Results & Booking History"));
        ...
        // SEARCH BUTTON (Updated to show Booking History)
        btnSearch.addActionListener(e -> {
            ...
            displayArea.setText(""); // Clear log for fresh results
            boolean foundGuest = false;

            // 1. Search in Guest File
    ...
    private JPanel createBookingPanel() {
        ...
        JPanel formPanel = new JPanel(new GridLayout(5, 2, 5, 5)); // Increased rows for Payment
        ...
        rCash = new JRadioButton("Cash", true); // Default selected
        ...
        btnBook.addActionListener(e -> {
            ...
            if (gid.isEmpty() || room.isEmpty() || nights.isEmpty()) {
        ...
        panel.add(btnBook, BorderLayout.CENTER);
